...
namespace Bioware.Resources {
    ...
    public class EFile : Container {
        public const string MOD_EXT = ".mod";
        public const string ERF_EXT = ".erf";
        public const string SAV_EXT = ".sav";
        public const string HAK_EXT = ".hak";

        public static bool IsERF(string path) {
            string ext = Path.GetExtension(path);
            return (ext == MOD_EXT || ext == ERF_EXT || ext == SAV_EXT || ext == HAK_EXT);
        }
        struct EKeyFrame {
